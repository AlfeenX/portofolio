  ...
  return (
    <section className=" h-screen justify-center items-center flex flex-col overflow-hidden border border-gray-200">
      <p className="font-nohemi text-4xl text-center max-w-7xl p-4">
        ...
        in both frontend and backend technologies, I thrive on creating
        innovative applications that solve real-world problems. My journey in
        coding has been fueled by curiosity and a relentless drive to learn,
        making me adept at navigating the ever-evolving landscape of web
        development.
      </p>
    </section>
  );
